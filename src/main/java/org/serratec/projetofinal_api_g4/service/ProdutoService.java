...
public class ProdutoService {
    ...
    public ProdutoDTO inserir(ProdutoDTO produtoDTO) {
       Categoria categoria = categoriaRepository.findById(produtoDTO.getCategoria().getId())
                .orElseThrow(() -> new RuntimeException("Categoria não encontrada pelo id." +
    ...
    public ProdutoDTO atualizar(Long id, ProdutoDTO produtoDTO) {
        Produto produto = produtoRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Produto não encontrado pelo id: " + id));
        
        Categoria categoria = categoriaRepository.findById(produtoDTO.getCategoria().getId())
                .orElseThrow(() -> new RuntimeException("Categoria não encontrada pelo id: " + produtoDTO.getCategoria().getId()));
