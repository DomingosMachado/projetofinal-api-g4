...
public class AvaliacaoController {
    ...
    @PostMapping
    public ResponseEntity<AvaliacaoDTO> criar(@RequestBody @Valid AvaliacaoRequestDTO requestDto) {
        System.out.println("DTO Recebido:");
        System.out.println("nota: " + requestDto.getNota());
        System.out.println("comentario: " + requestDto.getComentario());
        System.out.println("idProduto: " + requestDto.getIdProduto());
        System.out.println("idCliente: " + requestDto.getIdCliente());
        try {
